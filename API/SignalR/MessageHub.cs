...
namespace API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
           ...
           var otherUser = httpContext.Request.Query["user"]; // its the key for other user which must be send from client as hubs/messsage?user=otherUser
        ...
        private async Task<Group> RemoveFromMessageGroup()
        {
            ...
            throw new HubException("Failed to removefrom group");
